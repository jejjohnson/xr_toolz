...
:func:`xr_toolz.transforms.power_spectrum` (``isotropic=True`` or
``False``) and :func:`xr_toolz.metrics.psd_score`.
"""
...
class PSDIsotropicScorePanel(_PSDPanelBase):
    ...
    :func:`xr_toolz.metrics.psd_score` with ``isotropic=True``) on a
    ...
    :func:`xr_toolz.metrics._src.spectral.find_intercept_1D`).
