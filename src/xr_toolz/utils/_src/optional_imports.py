...
def _require_optional(module: str, *, extra: str, feature: str | None = None) -> Any:
    ...
    try:
        ...
        package = "scikit-image" if module.startswith("skimage") else module
        name = feature or module
        raise ImportError(
            f"{name} requires {package}. Install with: pip install 'xr_toolz[{extra}]'"
        ) from exc
